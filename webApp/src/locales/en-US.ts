export default {
  ...
  organizationAddEdit: {
    ...
    sections: { basicInfo: 'Basic Info', other: 'Other' },
    labels: { name: 'Name', abbrName: 'Abbr', parent: 'Parent', orgTypeDictCode: 'Organization Type', seqNo: 'Order', remark: 'Remark' },
    placeholders: {
  ...
  roleAddEdit: {
    ...
    titleEdit: 'Edit Role',
    sections: { basicInfo: 'Basic Info', other: 'Other' },
    labels: { roleCode: 'Role Code', roleName: 'Role Name', subSysOrTenant: 'Subsystem/Tenant', remark: 'Remark' },
    placeholders: {
