export default {
  ...
  accessRuleList: {
    placeholders: { systemCode: 'Subsystem', ruleType: 'Rule Type' },
    common: { yes: 'Yes', no: 'No', confirm: 'Confirm', cancel: 'Cancel' },
    messages: {
  ...
  accessRuleIpAddEdit: {
    ...
    labels: {
      subSysOrTenant: 'Subsystem / Tenant',
      ipStart: 'IP Start (numeric)',
      ipEnd: 'IP End (numeric)',
      ipType: 'IP Type (int)',
    ...
    messages: {
      loadFailed: 'Failed to load data.',
      noParentRule: 'No access rule exists for this subsystem/tenant yet. Create one under Access Rules first.',
