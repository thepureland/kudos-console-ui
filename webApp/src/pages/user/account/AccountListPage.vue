...
<template>
  <div class="account-list-page list-page-common">
    ...
    <account-form-page v-if="addDialogVisible" v-model="addDialogVisible" @response="afterAdd" />
    <account-form-page v-if="editDialogVisible" v-model="editDialogVisible" @response="afterEdit" :rid="rid" />
