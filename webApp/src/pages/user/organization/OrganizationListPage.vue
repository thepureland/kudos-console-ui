...
<template>
  <div class="organization-list-page list-page-common">
    ...
    <organization-form-page v-if="addDialogVisible" v-model="addDialogVisible" @response="afterAdd" />
    <organization-form-page v-if="editDialogVisible" v-model="editDialogVisible" @response="afterEdit" :rid="rid" />
