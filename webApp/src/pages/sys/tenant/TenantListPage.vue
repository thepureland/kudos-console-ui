...
<template>
  <div class="tenant-list-page list-page-common">
    ...
    <tenant-form-page v-if="addDialogVisible" v-model="addDialogVisible" @response="afterAdd" />
    <tenant-form-page v-if="editDialogVisible" v-model="editDialogVisible" @response="afterEdit" :rid="rid" />
