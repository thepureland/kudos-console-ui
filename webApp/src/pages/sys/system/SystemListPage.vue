...
<template>
  <div class="system-list-page list-page-common">
    ...
    <system-form-page v-if="addDialogVisible" v-model="addDialogVisible" @response="afterAdd" />
    <system-form-page v-if="editDialogVisible" v-model="editDialogVisible" @response="afterEdit" :rid="rid" />
