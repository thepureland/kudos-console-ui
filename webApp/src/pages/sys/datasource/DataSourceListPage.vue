...
<template>
  <div class="data-source-list-page list-page-common">
    ...
    <data-source-form-page v-if="addDialogVisible" v-model="addDialogVisible" @response="afterAdd" />
    <data-source-form-page v-if="editDialogVisible" v-model="editDialogVisible" @response="afterEdit" :rid="rid" />
