...
<template>
  <div class="domain-list-page list-page-common">
    ...
    <domain-form-page v-if="addDialogVisible" v-model="addDialogVisible" @response="afterAdd" />
    <domain-form-page v-if="editDialogVisible" v-model="editDialogVisible" @response="afterEdit" :rid="rid" />
